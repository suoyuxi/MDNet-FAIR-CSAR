...
def eval_rbbox_map(det_results,
    ...
    for i in range(num_classes):
        ...
        # pre_arr = np.array(precisions)
        # recall_arr[recall_arr==0] = 0.01
        # pre_arr[pre_arr == 0] = 0.01
        # F1_arr = 2 * (recall_arr * pre_arr) / (recall_arr + pre_arr)
        # maxidx = np.argmax(F1_arr)
        # print('catagory : ', i)
        # print('recall : ', recall_arr[maxidx])
        # print('precision : ', pre_arr[maxidx])
        # print('F1 : ', F1_arr[maxidx])
        # print('---'*6)
