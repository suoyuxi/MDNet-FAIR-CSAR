...
class SLDataset(CustomDataset):
    ...
    """
    CLASSES = ('Airbus_A220', 'Airbus_A320', 'Airbus_A330', 'Boeing737', 'Boeing747', 'Boeing767', 'Boeing777', 'Helicopter',
                'Gulfstream', 'Fokker-50', 'Airfreighter', 'Other_Aircraft',
                'General_Cargo_Ship', 'Bulk_Carrier', 'Container_Ship', 'Oil_Tanker', 'Warship', 'Motion_Defocusing_Ship', 'Other_Ship',
                'Tank', 'Tower', 'Bridge')
    ...
    def __init__(self,
        ...
        super(SLDataset, self).__init__(ann_file, pipeline, **kwargs)
    ...
    def load_annotations(self, ann_folder):
        ...
        if not ann_files:  # test phase
            ann_files = glob.glob(ann_folder + '/*.mat')
