_base_ = [
    '../_base_/datasets/sl_cfg.py', '../_base_/schedules/schedule_1x.py',
...
train_pipeline = [
    ...
    dict(type='STFTAnalysis', window_size=band_cnt),
    dict(
        type='RRandomFlip',
    ...
    dict(type='SarDefaultFormatBundle'),
    dict(type='Collect', keys=['img', 'img_stft', 'gt_bboxes', 'gt_labels'])
]
test_pipeline = [
    dict(type='LoadSLCMatFromFile'),
